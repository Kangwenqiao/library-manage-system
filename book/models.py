...
class Member(models.Model):
    user = models.OneToOneField(User, null=True, blank=True, on_delete=models.CASCADE, related_name='member')
...
class BorrowRecord(models.Model):
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name='borrow_records')
    ...
    book_link = models.ForeignKey(Book, null=True, blank=True, on_delete=models.SET_NULL, related_name='borrow_records')
    ...
    def __str__(self):
        return self.borrower+"->"+str(self.book_link or self.book)
    
    def save(self, *args, **kwargs):
        # profile = super(Profile, self).save(*args, **kwargs)
        if self.book_link:
            self.book_title = self.book_link.title
        elif self.book:
